...
---
#### Solution 1: transfer the user/kernel stack pointer through `sscratch` register
...
- This causes an exception to be generated in kernel mode, leading to the **system crash**
